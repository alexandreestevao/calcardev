package br.com.calcardev.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.calcardev"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                new Contact("Alexandre Estevão", "https://www.calcard.com/contatos", "contato@calcard.com"),
